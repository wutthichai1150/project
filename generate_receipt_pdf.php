...
$pdf->Cell(50, 10, 'นาย ชื่อ-สกุล ธนาคารกรุงไทย 6782754754', 0, 0);
...
$pdf->SetFont('freeserif', '', 10);
$pdf->Cell(0, 10, '---------------------------------------------', 0, 1, 'C');
$pdf->Cell(0, 10, 'ผู้รับเงิน', 0, 1, 'C');
$pdf->Ln(10);

// ช่องสำหรับลายเซ็นต์
$pdf->SetXY(10, 170);
$pdf->Cell(95, 10, 'ลายเซ็นต์ผู้จ่ายเงิน', 0, 0, 'L');
$pdf->Cell(95, 10, 'ลายเซ็นต์ผู้รับเงิน', 0, 1, 'R');
